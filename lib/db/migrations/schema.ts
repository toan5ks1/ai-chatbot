import { pgTable, foreignKey, uuid, timestamp, text, varchar, json, boolean, primaryKey, pgEnum } from "drizzle-orm/pg-core"
  import { sql } from "drizzle-orm"

export const productStatus = pgEnum("product_status", ['active', 'draft', 'archived'])
export const storePlan = pgEnum("store_plan", ['free', 'standard', 'pro'])
